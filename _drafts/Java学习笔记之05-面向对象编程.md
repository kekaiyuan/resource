...
# 概念
- 编程语言的演变
	![picture](/images/posts/java/javase/05-oop/language.png)
	- 第一代：机器语言
...
# 类和对象
- 现实世界是由什么组成的？
![picture](/images/posts/java/javase/05-oop/world.png)
- 对象和类的概念
	- 对象是具体的事物
	- 类是对对象的抽象
...
- 对象
	...
	- 列出尼古拉斯·凯奇驾驶的这辆法拉利F360 Spider的属性和方法
		- ![picture](/images/posts/java/javase/05-oop/Ferrari.png)
		- 属性：
			- 品牌：法拉利
			- 型号：F360 Spider
			- 颜色：黄色
		...
		- 方法：
			...
			- 加速
	- 列出小狗对象的属性和方法
		- ![picture](/images/posts/java/javase/05-oop/dog.png)
		- 属性：
			- 颜色：白色
		- 方法：
			- 叫
...
- 类
	- 从对象中抽象出“类”
		- 抽取出下列对象的属性和方法的共同特征
		   ![picture](/images/posts/java/javase/05-oop/cars.png)
			- 轿车类
				- 属性
					- 车轮
					- 引擎
...
- 类和对象的关系
	...
	- ![picture](/images/posts/java/javase/05-oop/person.png)
- 对象和类的总结
	- 对象和类的关系：特殊到一般，具体到抽象。
	- 类叫做class。

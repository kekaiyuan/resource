...
- Unicode
	- 国际通用字符集 
	- 2个字节
- ![picture](/images/posts/java/javase/02-datatype-operator/char-set.jpg)

# Java数据类型
- Java是一种强类型语言
	- 常量是有数据类型的
	- 变量都必须声明其数据类型。
	 ![picture](/images/posts/java/javase/02-datatype-operator/datatype.png)


## 整型常量
 ![picture](/images/posts/java/javase/02-datatype-operator/integer.png)
- 十进制整数
	- 99,-500,0
- 八进制整数
	- 以0开头，如：015
...
## 浮点型
 ![picture](/images/posts/java/javase/02-datatype-operator/float.png)
- float类型
...
- 使用转义字符‘\’来将其后的字符转变为其它的含义
	 ![picture](/images/posts/java/javase/02-datatype-operator/char.png)
...
## 算术运算符
 ![picture](/images/posts/java/javase/02-datatype-operator/math-op.png)
- 二元运算符的类型提升
	- 整数运算
...
- 一元运算符  ++,\-\-
	 ![picture](/images/posts/java/javase/02-datatype-operator/unitary.png)
...
- 扩展赋值运算符
	- 算术运算符和赋值运算符结合
- ![picture](/images/posts/java/javase/02-datatype-operator/ex-op.png)
...
- 逻辑表达式的结果是布尔值
  ![picture](/images/posts/java/javase/02-datatype-operator/logic-op.png)
- &和&&的区别
	- &
		- 无论任何情况，“&”两边的表达式都会参与计算
	- &&
...
- ![picture](/images/posts/java/javase/02-datatype-operator/an-op.png)
...
## 运算符的优先级
- ![picture](/images/posts/java/javase/02-datatype-operator/op-priority.png)
- 赋值<三目<逻辑<关系 <算术<单目
...
- 算术运算时的转换
	...
	- ![picture](/images/posts/java/javase/02-datatype-operator/math-trans.png)

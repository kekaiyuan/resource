...
- 一组相互连接的计算机
	- 多台计算机组成
	- 使用物理线路进行连接
- ![picture](/images/posts/java/javase/net/net01.png)
- ![picture](/images/posts/java/javase/net/net02.png)
...
- 通信协议
	- 通信的规则
	- TCP，UDP
- ![picture](/images/posts/java/javase/net/net-elements.png)


## 网络模型
- OSI参考模型
	- 开放系统互连参考模型（Open System Interconnect）
	- ![picture](/images/posts/java/javase/net/OSI.png)
- TCP/IP参考模型
	- 传输控制/网际协议 Transfer Controln Protocol/Internet Protocol
	- ![picture](/images/posts/java/javase/net/TCPIP.png)
...
- IP表示方法
	- 点分十进制
	- ![picture](/images/posts/java/javase/net/IP-address-express.png)
- IP地址 = 网络ID +主机ID
	- 网络ID
		- 标识计算机或网络设备所在的网段
	- 主机ID
...
- 根据网络ID和主机ID的长度可以把IP地址划分为五类
  ![picture](/images/posts/java/javase/net/IP-cate.png)
...
![picture](/images/posts/java/javase/net/InetAddress.png)
![picture](/images/posts/java/javase/net/InetAddress-method.png)
...
- ![picture](/images/posts/java/javase/net/socket.png)

# 基于TCP协议的Socket编程
- 进行网络通信时，Socket需要借助数据流来完成数据的传递工作
![picture](/images/posts/java/javase/net/datastream.png)
- 代码示例：用户登录功能
![picture](/images/posts/java/javase/net/client.png)
![picture](/images/posts/java/javase/net/server.png)

...
# File类
- ![picture](/images/posts/java/javase/io/fileclass.png)
- 常用方法
![picture](/images/posts/java/javase/io/filemethods.png)
...
- 输入/输出流与数据源
	- 输入流：XXX——>程序
	  ![picture](/images/posts/java/javase/io/inputstream.png)
	- 输出流：程序——>XXX
	  ![picture](/images/posts/java/javase/io/outputstream.png)
	- 数据源
		- 提供原始数据的原始媒介。
...
- Java流的分类
	...
	- 按照**功能**划分
		- 节点流
			- 可以直接从数据源或目的地读写数据。
			-  ![picture](/images/posts/java/javase/io/nodestream.png)
		- 处理流（包装流）
			- 不直接连接到数据源或目的地，是其他流进行**封装**。目的主要是简化操作和提高性能。
			-  ![picture](/images/posts/java/javase/io/packetstream.png)
		-  怎么理解节点流和处理流？
			-  假设现在有两个水箱

...
在 Spring MVC 中，还有很多视图解析器，其具体逻辑各不相同，但目的都是把逻辑视图转换为实际视图。

我们在之前的操作中已经用了SpringMVC中提供的视图解析器，那么如果我们需要实现自己的视图解析器该如何操作呢？

![image-20200312211420457](\images\posts\java\framework\spring-mvc\02\viewResolver.png)

...
description: Java Spring MVC 03——简单介绍及使用方法（三）
keywords: Spring MVC, Java
mermaid: true
---

Java Spring MVC 03——简单介绍及使用方法（三）
...
而是直接把内容返回到 `Http Response Body` 中，然后会直接显示在前端页面中。<br>
![](\images\posts\java\framework\spring-mvc\03\json.png)

...
public class LogUtil {
    ...
    @AfterReturning("execution( public Integer com.kky.service.MyCalculator.*(Integer,Integer))")
    public static void stop(JoinPoint joinPoint) {
        System.out.println(joinPoint.getSignature().getName() +
                " 方法执行完成，结果是：");
    }

    @AfterThrowing("execution( public Integer com.kky.service.MyCalculator.*(Integer,Integer))")
    public static void logException(JoinPoint joinPoint) {
        System.out.println(joinPoint.getSignature().getName() + " 方法出现异常：");
    }

	@After("execution( public Integer com.kky.service.MyCalculator.*(Integer,Integer))")
...
在 `@AfterThrowing` 注解中添加 `thowing` 参数，并写入方法形参。

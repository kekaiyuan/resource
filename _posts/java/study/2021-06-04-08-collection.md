	...
	- HashSet
		...
		- 子类：LinkedHashSet
			- 采用哈希表存储结构，同时使用链表维护次序
			   ![enter description here](/images/posts/java/study/collection/hashset.png)
			- 有序（添加顺序）
	- TreeSet
		- 采用二叉树（红黑树）的存储结构
		  ![enter description here](/images/posts/java/study/collection/treeset.png)
...
![enter description here](/images/posts/java/study/collection/hash.png)
...
# LinkList
## LinkedList类特有的方法
![enter description here](/images/posts/java/study/collection/linkedlist-methods.png)

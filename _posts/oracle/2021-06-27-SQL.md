...
- 子查询返回一行记录
- 使用单行记录比较运算符
	![enter description here](/images/posts/oracle/query/single-subquery-op.png)
...
- 子查询返回多行行记录
- 使用集合比较运算符
	![enter description here](/images/posts/oracle/query/multi-subquery-op.png)

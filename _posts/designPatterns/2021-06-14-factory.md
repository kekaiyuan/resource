---
layout: post
title: Java设计模式之03——工厂模式Factory
categories: Java设计模式之03——工厂模式Factory
description: some word here
keywords: Java，设计模式
---

Java设计模式之03——工厂Factory
...
抽象工厂的目的主要有两个
- 维护产品族的内容
	- 我通过抽象工厂得到的产品族一定是唯一的。就像我通过上面的两个抽象工厂一定只能得到 {汽车，AK47，方便面} 和 {魔法扫帚，魔法棒，魔法蘑菇} 之中的一个产品族。我不可能得到 {汽车，魔法棒，魔法蘑菇} 这样的产品族。
...
- 一套皮肤是由许多组件构成的，使用抽象工厂，就不会出现换皮肤，一半是新皮肤，一半是旧皮肤的错误。

---
layout: post
title: Java设计模式之02——策略模式
categories: DesignPatterns
description: Java设计模式之02——策略模式
keywords: Java，设计模式
---
...
# 源码链接
本文源码链接[https://github.com/kekaiyuan/designpatterns/tree/main/strategy](https://github.com/kekaiyuan/designpatterns/tree/main/strategy)
- 现在有两个类，Cat类和Dog类
	- Cat类代表猫，有两个属性：体重和身高
	- Dog类代表狗，只有一个属性：食量

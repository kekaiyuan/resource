...
从现实中考虑，明星都有经纪人，经纪人就是明星的**代理**。

厂商需要找明星合作，往往不是直接找明星，而是找经纪人商量。

而经纪人**知道**明星会做什么：会唱什么歌，会跳什么舞，会演什么戏……

**这说明经纪人和明星继承于同一个接口。**

而且经纪人可以替明星做一些**控制**：比如哪些厂商的合作可以接……

编程中的代理模式，就是将某个类的行为抽象出来成为接口。

使得外部可以继承这个接口调用该类的方法，并且做出一定的控制。
...
### 动态代理
在静态代理中的日志代理只能填写关于 Tank 类的日志。<br>
